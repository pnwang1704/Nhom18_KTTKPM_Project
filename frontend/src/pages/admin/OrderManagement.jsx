...
const mockOrders = [
  { id: '#ORD-9281', customer: 'Phan Nhật Quang', email: 'quang@example.com', products: 2, total: 1299, status: 'Delivered', payment: 'Paid', date: '2024-05-10', method: 'Credit Card' },
  { id: '#ORD-9282', customer: 'Nguyễn Văn A', email: 'vana@example.com', products: 1, total: 899, status: 'Pending', payment: 'Unpaid', date: '2024-05-11', method: 'Bank Transfer' },
  { id: '#ORD-9283', customer: 'Trần Thị B', email: 'thib@example.com', products: 3, total: 2150, status: 'Shipping', payment: 'Paid', date: '2024-05-11', method: 'E-Wallet' },
  { id: '#ORD-9284', customer: 'Lê Văn C', email: 'vanc@example.com', products: 1, total: 750, status: 'Delivered', payment: 'Paid', date: '2024-05-09', method: 'Credit Card' },
  { id: '#ORD-9285', customer: 'Phạm Minh D', email: 'minhd@example.com', products: 2, total: 1100, status: 'Cancelled', payment: 'Refunded', date: '2024-05-08', method: 'Bank Transfer' },
  { id: '#ORD-9286', customer: 'Hoàng Thị E', email: 'thie@example.com', products: 1, total: 1599, status: 'Pending', payment: 'Unpaid', date: '2024-05-12', method: 'COD' },
];

const statusStyles = {
  Delivered: 'text-emerald-600 bg-emerald-50 border-emerald-100',
  Pending: 'text-orange-600 bg-orange-50 border-orange-100',
  Shipping: 'text-blue-600 bg-blue-50 border-blue-100',
    ...
    <div className="space-y-8 pb-10">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div>
          ...
          <p className="text-muted-foreground mt-1">Monitor and manage customer orders and fulfillment.</p>
        </div>
      ...
      <div className="flex items-center gap-2 border-b border-border pb-px overflow-x-auto no-scrollbar">
        {['All', 'Pending', 'Shipping', 'Delivered', 'Cancelled'].map((tab) => (
          <button
            key={tab}
      ...
      <div className="bg-card rounded-3xl border border-border overflow-hidden shadow-sm">
            ...
            <tbody className="divide-y divide-border">
              {mockOrders.map((order) => (
                ...
                >
                  ...
                  <td className="px-8 py-5 text-sm font-medium text-muted-foreground">{order.products} items</td>
                  <td className="px-8 py-5">
                    <p className="text-sm font-bold tracking-tight">${order.total.toLocaleString()}</p>
        ...
        <div className="p-6 border-t border-border flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-muted/10">
          <p className="text-sm text-muted-foreground font-medium italic">
            * All order timestamps are in UTC+7
          </p>
          <div className="flex items-center gap-2">
