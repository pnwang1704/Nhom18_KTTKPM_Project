...
const kpiCards = [
  { label: 'Tổng doanh thu', value: '$128,430', trend: '+12.5%', isUp: true, icon: DollarSign, color: 'text-blue-600', bg: 'bg-blue-50' },
  { label: 'Đơn hàng hôm nay', value: '42', trend: '+18.2%', isUp: true, icon: ShoppingBag, color: 'text-emerald-600', bg: 'bg-emerald-50' },
  { label: 'Tổng khách hàng', value: '1,240', trend: '-2.4%', isUp: false, icon: Users, color: 'text-violet-600', bg: 'bg-violet-50' },
  { label: 'Tổng sản phẩm', value: '156', trend: '+4.1%', isUp: true, icon: Smartphone, color: 'text-orange-600', bg: 'bg-orange-50' },
  { label: 'Sắp hết hàng', value: '12', trend: 'Cấp bách', isUp: false, icon: AlertTriangle, color: 'text-rose-600', bg: 'bg-rose-50' },
];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left">
              ...
              <tbody className="divide-y divide-border">
                {[
                  { id: '#ORD-9281', customer: 'Phan Nhật Quang', status: 'Đã giao hàng', amount: '$1,299', statusColor: 'text-emerald-600 bg-emerald-50' },
                  { id: '#ORD-9282', customer: 'Nguyễn Văn A', status: 'Đang xử lý', amount: '$899', statusColor: 'text-orange-600 bg-orange-50' },
                  { id: '#ORD-9283', customer: 'Trần Thị B', status: 'Đang vận chuyển', amount: '$2,150', statusColor: 'text-blue-600 bg-blue-50' },
                  { id: '#ORD-9284', customer: 'Lê Văn C', status: 'Đã giao hàng', amount: '$750', statusColor: 'text-emerald-600 bg-emerald-50' },
                  { id: '#ORD-9285', customer: 'Phạm Minh D', status: 'Đã hủy', amount: '$1,100', statusColor: 'text-rose-600 bg-rose-50' },
                ].map((order) => (
        ...
        >
          <div className="p-8 border-b border-border flex items-center justify-between">
            ...
            <button className="text-primary text-sm font-bold hover:underline">Xem kho hàng</button>
          </div>
          <div className="p-8 space-y-6">
            {[
              { name: 'iPhone 15 Pro Max', sales: 124, revenue: '$148,800', image: 'https://images.unsplash.com/photo-1696446701796-da61225697cc?auto=format&fit=crop&q=80&w=100' },
              { name: 'Samsung Galaxy S24 Ultra', sales: 98, revenue: '$117,600', image: 'https://images.unsplash.com/photo-1610945265064-0e34e5519bbf?auto=format&fit=crop&q=80&w=100' },
              { name: 'iPad Pro M2', sales: 76, revenue: '$83,600', image: 'https://images.unsplash.com/photo-1544244015-0df4b3ffc6b0?auto=format&fit=crop&q=80&w=100' },
              { name: 'Apple Watch Series 9', sales: 65, revenue: '$25,935', image: 'https://images.unsplash.com/photo-1546868871-7041f2a55e12?auto=format&fit=crop&q=80&w=100' },
            ].map((product) => (
