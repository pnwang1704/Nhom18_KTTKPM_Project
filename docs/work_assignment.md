...
| **Tuần 7**<br>(20/04 - 26/04) | **Order & Chat** | - Xây dựng `chat-service` (Socket.io).<br>- Tích hợp Lịch sử mua hàng vào Profile. | - Xử lý logic hủy đơn hàng, hoàn trả kho.<br>- Cập nhật trạng thái đơn hàng thời gian thực. |
...
| **Tuần 10**<br>(11/05 - 17/05) | **MVP Final** | - Hoàn thiện Chat Dashboard, Việt hóa & Dark Mode.<br>- Dọn dẹp code, fix bug & **Bàn giao dự án**. | - Viết tài liệu hướng dẫn vận hành.<br>- Kiểm tra tính nhất quán dữ liệu & Demo cuối kỳ. |
